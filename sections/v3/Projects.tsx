    ...
    <>
      ...
      <div ref={ref} style={{
        ...
        <a href={p.href} target="_blank" rel="noopener noreferrer" style={{
          ...
          <div style={{display:"flex",alignItems:"center",gap:8,padding:"16px 16px 0",background:"#ffffff",borderTop:"1px solid rgba(0,0,0,0.10)",borderLeft:"1px solid rgba(0,0,0,0.10)",borderRight:"1px solid rgba(0,0,0,0.10)",borderRadius:"12px 12px 0 0"}}>
