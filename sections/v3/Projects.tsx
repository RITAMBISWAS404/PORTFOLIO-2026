    ...
    <>
      ...
      <div ref={ref} style={{
        ...
        <a href={p.href} target="_blank" rel="noopener noreferrer" style={{
          ...
          <div style={{display:"flex",alignItems:"center",gap:8,padding:"16px 16px 0",background:"#ffffff",borderTop:"1px solid rgba(0,0,0,0.10)",borderLeft:"1px solid rgba(0,0,0,0.10)",borderRight:"1px solid rgba(0,0,0,0.10)",borderRadius:"20px 20px 0 0"}}>
            <div style={{width:32,height:32,borderRadius:12,overflow:"hidden",flexShrink:0}}>
          ...
          <div style={{padding:16,display:"flex",flexWrap:"wrap",gap:8,background:"#222222"}}>
            {p.tags.map(t=>(
              <div key={t} className="pill-radius" style={{...tagStyle,padding:"5px 12px",borderRadius:9999,background:"rgba(255,255,255,0.10)",border:"1px solid rgba(255,255,255,0.10)",color:"#ffffff"}}>
                {t}
              </div>
            ))}
          </div>
