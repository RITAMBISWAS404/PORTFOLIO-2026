          ...
          <div style={{ display:"flex", alignItems:"center", flexWrap:"wrap", gap:8 }}>
            ...
            {e.img
              ? (Array.isArray(e.img) ? e.img : [e.img]).map((src: string, idx: number) => (
                  <div key={idx} style={{ width:24, height:24, borderRadius:4, flexShrink:0, overflow:"hidden" }}>
                    <img src={src} alt={e.company} style={{width:"100%",height:"100%",objectFit:"cover",display:"block"}}/>
                  </div>
                ))
              : <div style={{ width:24, height:24, borderRadius:4, flexShrink:0, background:e.logoBg,
...
export default function Experience() {
  return (
    <section id="experience" style={{ ...col, paddingTop: 24, paddingBottom: 24 }} className="v3-section">
