...
import { MdPsychology, MdDesignServices, MdLayers, MdRocketLaunch } from "react-icons/md";
...
const steps = [
  { label: "Understand Deeply",   body: "I dig into user needs, business goals, and constraints before opening Figma. The clearer the problem, the sharper everything that follows.",                                         icon: MdPsychology },
