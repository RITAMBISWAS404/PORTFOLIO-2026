        ...
        <Reveal>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 24 }}>
            {[
              ...
              { label: "AI INTEGRATION", icon: <Zap        size={12} color="#fff" strokeWidth={2} />, bg: "var(--pop-orange)" },
              { label: "MOBILE",         icon: <Smartphone size={12} color="#fff" strokeWidth={2} />, bg: "var(--pop-blue)" },
              { label: "INDIAN RETAIL",  icon: <Store      size={12} color="#fff" strokeWidth={2} />, bg: "var(--pop-pink)" },
            ].map(t => (
