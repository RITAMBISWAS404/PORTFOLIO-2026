...
function Perspective({ text }: { text: string }) {
  return <IconCard icon={QuoteIcon} label="Perspective" body={`“${text}”`} bg="#ffffff" iconColor="#36A2E1" textColor="#222222" noHover />;
}

function Lesson({ text }: { text: string }) {
  return <IconCard icon={BookOpen} label="Lesson" body={text} bg="#ffffff" iconColor="#36A2E1" textColor="#222222" noHover />;
}

function Insight({ text }: { text: string }) {
  return <IconCard icon={Lightbulb} label="Insight" body={text} bg="#ffffff" iconColor="#36A2E1" textColor="#222222" noHover />;
}
    ...
    <ThemeProvider defaultTheme="light">
      ...
      <section style={{ ...col, paddingBottom: 0 }} className="v3-section">
        <Reveal>
          ...
          <IconCard icon={Lock} label="A Quick Note" bg="#ffffff" iconColor="#36A2E1" textColor="#222222" noHover
      ...
      <section style={{ ...col }} className="v3-section">
        <div className="shop-stats-grid">
          <Card label="12M+ Kirana Stores" num="" body="Neighbourhood grocery shops across India, most still running on paper." delay={0}    bg="#ffffff" iconColor="#36A2E1" textColor="#222222" noHover icon={Store} />
          <Card label="5 Core Flows"       num="" body="Splash, onboarding, dashboard, scan-to-bill, credit management." delay={0.08} bg="#ffffff" iconColor="#36A2E1" textColor="#222222" noHover icon={GitBranch} />
          <Card label="30 Second Bills"    num="" body="Typical time from scan to payment confirmation for a 5-item bill." delay={0.16} bg="#ffffff" iconColor="#36A2E1" textColor="#222222" noHover icon={Clock} />
        </div>
      </section>
      ...
      <section id="shop-flow" style={{ ...col }} className="v3-section">
        ...
        <div className="mt-section" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <Reveal delay={0.12}>
            <div style={{ background: "#ffffff", boxShadow: "0px 2px 9px 0px rgba(0,0,0,0.05)", borderRadius: 8, padding: "20px 24px", textAlign: "center" }}>
              <p className="f16" style={{ fontWeight: 500, color: C.t2, lineHeight: 1.7 }}>
      ...
      <section id="shop-reflection" style={{ ...col }} className="v3-section">
        ...
        <div className="mt-section" style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          <div className="shop-reflection-grid">
            <IconCard icon={FileText}   label="Test with real users earlier" body="All design decisions here came from observation and research. One session watching an actual kirana owner use the scan screen would have caught the gap before it became a gap." bg="#ffffff" iconColor="#36A2E1" textColor="#222222" noHover delay={0}    />
            <IconCard icon={Lightbulb}  label="Design the failure states"    body="Every happy path is designed. None of the error states are. Unrecognised items, camera failure, no internet. Those screens do not exist yet and they should." bg="#ffffff" iconColor="#36A2E1" textColor="#222222" noHover delay={0.08} />
      ...
      <div style={{ ...col, display: "flex", justifyContent: "flex-start" }} className="v3-section">
        <button
          ...
          style={{
            ...
            background: "rgba(0,0,0,0.07)", color: C.t1,
