  ...
  return (
    <div ref={ref}
      ...
      style={{
        ...
        boxShadow: isShopez ? "0px 2px 9px 0px rgba(0,0,0,0.05)" : "none",
      ...
      {isColored ? (
        <>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", position: "relative", zIndex: 1 }}>
            <span className="card-colored-heading" style={{ fontWeight: 600, color: chipIcon ? "#222222" : `var(--exp-card-heading, ${textColor})` }}>{label}</span>
            {num && <span className="card-colored-heading" style={{ fontWeight: 600, color: chipIcon ? "#222222" : `var(--exp-card-heading, ${textColor})`, opacity: 0.75, flexShrink: 0, marginLeft: 8 }}>{num}</span>}
          </div>
          <p className="card-colored-body" style={{ fontWeight: 500, color: "#666666", opacity: 1, lineHeight: 1.6, position: "relative", zIndex: 1 }}>{body}</p>
          <style>{`
        ...
        <>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", position: "relative", zIndex: 1 }}>
            <span style={{ fontSize: 12, fontWeight: 600, color: "var(--color-text-1)", letterSpacing: "0.08em" }}>{label}</span>
            <span style={{ fontSize: 12, fontWeight: 600, color: hovered ? "var(--color-text-2)" : "var(--color-text-3)", transition: "color 0.15s" }}>{num}</span>
          </div>
          <p className="card-body" style={{ fontWeight: 500, color: "var(--color-text-2)", lineHeight: 1.6, position: "relative", zIndex: 1 }}>{body}</p>
