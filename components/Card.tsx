...
import { C, revealStyle } from "@/lib/tokens";
  ...
  return (
    <div ref={ref}
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <span style={{ fontSize: 12, fontWeight: 500, color: hovered ? C.t2 : C.t3, transition: "color 0.15s" }}>{num}</span>
      </div>
      <p className="card-body" style={{ fontWeight: 400, color: C.t2, lineHeight: 1.6 }}>{body}</p>
