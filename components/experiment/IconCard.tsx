  ...
  return (
    <div ref={ref}
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", position: "relative", zIndex: 1 }}>
        <span className="card-colored-heading" style={{ fontWeight: 600, color: textColor }}>{label}</span>
        {right && (
          <span className="card-colored-heading" style={{ fontWeight: 600, color: textColor, opacity: 0.75, flexShrink: 0, marginLeft: 8 }}>
            {right}
          </span>
        )}
      </div>
